...
clear; clc;
filename = 'D:\Dropbox\GitHub\ambiguity_premium\smpl_put.txt';
delimiter = ' ';
...
smplput = table;
smplput.Kp = cell2mat(raw(:, 1));
smplput.P_bid = cell2mat(raw(:, 2));
smplput.P_ask = cell2mat(raw(:, 3));
