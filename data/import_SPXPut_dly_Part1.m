...
% Below takes 4.4s (DORM PC)
tic
filename = 'F:\Dropbox\GitHub\ambiguity_premium\data\rawdata\SPXPut_dly_2nd_Part1.csv';
...
%%
secid = T.secid;
% Below takes 76.6s (DORM PC)
tic
date = T.date; date = char(date); date = datenum(date);
toc
symbol = T.symbol;
% Below takes 74.2s (DORM PC)
tic
...
%%
save('rawOpData_2nd_P_Part1.mat', 'PutData', 'symbol_P');