...
% Below takes 3.38s (LAB PC)
tic
filename = 'D:\Dropbox\GitHub\ambiguity_premium\data\rawdata\SPXCall_dly_2nd_Part3.csv';
...
%%
secid = T.secid;
% Below takes 55.3s (LAB PC)
tic
date = T.date; date = char(date); date = datenum(date);
toc
symbol = T.symbol;
% Below takes 55s (LAB PC)
tic
...
%%
save('rawOpData_2nd_C_Part3.mat', 'CallData', 'symbol_C');