...
% Below takes 7.8s (LAB PC)
tic
filename = 'D:\Dropbox\GitHub\ambiguity_premium\data\rawdata\SPXCall_dly_2nd_Part1.csv';
...
%%
secid = T.secid;
% Below takes 72.6s (LAB PC)
tic
date = T.date; date = char(date); date = datenum(date);
toc
symbol = T.symbol;
% Below takes 72.6s (DORM PC)
tic
...
%%
save('rawOpData_2nd_C_Part1.mat', 'CallData', 'symbol_C');