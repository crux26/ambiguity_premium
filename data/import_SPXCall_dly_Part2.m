...
% Below takes 5.68s (LAB PC)
tic
filename = 'D:\Dropbox\GitHub\ambiguity_premium\data\rawdata\SPXCall_dly_2nd_Part2.csv';
...
%%
secid = T.secid;
% Below takes 87s (LAB PC)
tic
date = T.date; date = char(date); date = datenum(date);
toc
symbol = T.symbol;
% Below takes 86.3s (LAB PC)
tic
...
%%
save('rawOpData_2nd_C_Part2.mat', 'CallData', 'symbol_C');