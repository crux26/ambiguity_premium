...
% Below takes 5.53s (DORM PC)
tic
filename = 'F:\Dropbox\GitHub\ambiguity_premium\data\rawdata\SPXPut_dly_2nd_Part2.csv';
...
%%
save('rawOpData_2nd_P_Part2.mat', 'PutData', 'symbol_P');