...
%
%    D:\Dropbox\GitHub\ambiguity_premium\smpl_data.txt
%
% To extend the code to different selected data or a different text file, generate a function instead of a script.

% Auto-generated by MATLAB on 2017/10/23 21:37:49

%% Initialize variables.
filename = 'D:\Dropbox\GitHub\ambiguity_premium\smpl_data.txt';
delimiter = ' ';
...
smpldata = table;
smpldata.K_1st = cell2mat(raw(:, 1));
smpldata.C_1st = cell2mat(raw(:, 2));
smpldata.P_1st = cell2mat(raw(:, 3));

smpldata.K_2nd = cell2mat(raw(:, 5));
smpldata.C_2nd = cell2mat(raw(:, 6));
smpldata.P_2nd = cell2mat(raw(:, 7));
