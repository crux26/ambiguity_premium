...
% Below takes 4.85s
tic
filename = 'F:\Dropbox\GitHub\ambiguity_premium\data\rawdata\SPXPut_dly_2nd_Part4.csv';
...
%%
secid = T.secid;
% Below takes 85.7s (DORM PC)
tic
date = T.date; date = char(date); date = datenum(date);
toc
symbol = T.symbol;
% Below takes 82s (DORM PC)
tic
...
%%
save('rawOpData_2nd_P_Part4.mat', 'PutData', 'symbol_P');